...
In order to create the plugin tables, run the https://docs.killbill.io/latest/aviate-mysql-ddl.sql[Aviate MySQL DDL] or https://docs.killbill.io/latest/aviate-postfewsql-ddl.sql[Aviate PostgreSQL DDL] depending on your database.
